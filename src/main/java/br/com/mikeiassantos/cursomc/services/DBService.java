...
import br.com.mikeiassantos.cursomc.domain.Cidade;
...
import br.com.mikeiassantos.cursomc.domain.Produto;
import br.com.mikeiassantos.cursomc.domain.enums.EstadoPagamento;
import br.com.mikeiassantos.cursomc.domain.enums.Perfil;
import br.com.mikeiassantos.cursomc.domain.enums.TipoCliente;
import br.com.mikeiassantos.cursomc.repositories.CategoriaRepository;
import br.com.mikeiassantos.cursomc.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "plenuslem@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Costa", "mikeiassantos16@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("999419930", "36390405"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Acre", "937", "Casa", "Mimoso 2", "47850000", cli2, c2);
